...
class Advisor:
    ...
    async def generate_personalized_plan(self, user_id: int, session: AsyncSession) -> Dict[str, Any]:
        ...
        # see _estimate_start_hour. Replaces the old `profile.preferred_hour
        # or 18`, which in practice was *always* 18 because that column is
        # never recalculated anywhere else in the codebase.
